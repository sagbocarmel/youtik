...
<div class="container form_style">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Formulaire de demande de retrait') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('retraitmail') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                           ...
                           <div class="form-group row">
                            <label for="retrait" class="col-md-4 col-form-label text-md-right">{{ __('Montant à retirer') }}</label>                      

                            <div class="col-md-6">
                                <input  type="number" class="form-control @error('retrait') is-invalid @enderror" name="retrait" value="{{ old('retrait')}}" required autofocus min=100 max= "{{  Auth::user()->invest + Auth::user()->bonus  }}">
